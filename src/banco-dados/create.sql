...
ALTER TABLE PEDIDOS ADD CONSTRAINT PEDIDOS_fk1 FOREIGN KEY (end_id) REFERENCES CLIENTE_ENDERECOS(end_id);
...
ALTER TABLE CLIENTE_ENDERECOS ADD CONSTRAINT CLIENTE_ENDERECOS_fk0 FOREIGN KEY (usu_id) REFERENCES CLIENTES(usu_id);

ALTER TABLE CLIENTE_ENDERECOS ADD CONSTRAINT CLIENTE_ENDERECOS_fk1 FOREIGN KEY (cid_id) REFERENCES CIDADES(cid_id);
